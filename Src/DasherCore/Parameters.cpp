...
namespace Dasher{
  namespace Settings {
	...
	const std::unordered_map<Parameter, const Parameter_Value> parameter_defaults = {
		...
		{BP_PALETTE_CHANGE       , Parameter_Value{"PaletteChange"        , PARAM_BOOL, Persistence::PERSISTENT, true , "PaletteChange"}},
		...
		{LP_DASHER_FONTSIZE      , Parameter_Value{ "DasherFontSize"            , PARAM_LONG, Persistence::PERSISTENT, 2l    , "DasherFontSize"}},
